...
class SetRTControlOutputRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetRTControlOutputRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetRTControlOutputRequest
    let len;
    let data = new SetRTControlOutputRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetRTControlOutputRequest(null);
...
class SetRTControlOutputResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetRTControlOutputResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetRTControlOutputResponse
    let len;
    let data = new SetRTControlOutputResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetRTControlOutputResponse(null);
...
module.exports = {
  ...
  Response: SetRTControlOutputResponse,
  md5sum() { return 'adc3c45016368698475e43bea709f99f'; },
  datatype() { return 'dsr_msgs/SetRTControlOutput'; }
};
