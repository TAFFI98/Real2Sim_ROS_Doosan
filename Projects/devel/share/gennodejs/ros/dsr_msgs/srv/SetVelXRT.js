...
class SetVelXRTRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetVelXRTRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetVelXRTRequest
    let len;
    let data = new SetVelXRTRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetVelXRTRequest(null);
...
class SetVelXRTResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetVelXRTResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetVelXRTResponse
    let len;
    let data = new SetVelXRTResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'dsr_msgs/SetVelXRTResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetVelXRTResponse(null);
...
module.exports = {
  ...
  Response: SetVelXRTResponse,
  md5sum() { return '761d85a527beb96265a49a9c48c83232'; },
  datatype() { return 'dsr_msgs/SetVelXRT'; }
};
