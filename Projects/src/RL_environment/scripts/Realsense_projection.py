...
class Realsense_projection:
  def __init__(self, img_path, sole_number, global_coord_path):
    ...
    self.local_coord_path = '/root/catkin_ws/src/RL_environment/scripts/dataset_config/suola_%s.txt' % (sole_number) # burr with respect to sole camera frame
  ...
  def define_tansformation_matrix_global_to_sole_frame(self, global_coord_path):
